...
## 10 h of wear time) -- This is an abstract way of doing it that just so
## happens to work because of how the `PAXDAY` variable is formatted. It's not
## crucial to understand how this is working. Other solutions will apply to most
## datasets, but I have chosen this approach here because it is concise
example_data$valid_index <- as.vector(tapply(
  example_data$is_wear, example_data$PAXDAY, sum
))[example_data$PAXDAY] >= 600
